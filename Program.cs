...
namespace ProjectKostumer
{
    class Program
    {
        ...
        static void TampilMenu()
        {
            ...
            Console.WriteLine("1. Insert Costumer");
            Console.WriteLine("2. Delete Costumer");
            Console.WriteLine("3. Print Costumer");
        ...
        static void TambahKostumer()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("Insert Data Costumer\n");
        ...
        static void HapusKostumer()
        {
            ...
            int i = -1, hapus = -1;
            Console.WriteLine("Delete Data Costumer\n");
            Console.Write("Kode Kostumer : ");
        ...
        static void TampilKostumer()
        {
            ...
            if (Urut < 1)
            {
                Console.WriteLine("Data Kostumer Tidak ada");
            }
